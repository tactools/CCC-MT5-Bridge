...
March 29, 2019
support for huobi ( different filling_order type ) line 1503
...
#include <Trade\DealInfo.mqh>  
 ...
 bool TRADE_DEBUG = true;
 
 input string ExchangeFillType= "Binance";
...
//--- EXCHANGE execution mode
   ...
   if(ExchangeFillType =="Binance"){
       m_type_filling=ORDER_FILLING_RETURN;
      if(TRADE_DEBUG)  Print("FillingCheck() , changing m_type_filling to ORDER_FILLING_RETURN , value = " + IntegerToString(m_type_filling) ); 
  
   }
   if(ExchangeFillType =="Huobi"){
       m_type_filling=ORDER_FILLING_FOK;
      if(TRADE_DEBUG)  Print("FillingCheck() , changing m_type_filling to ORDER_FILLING_FOK , value = " + IntegerToString(m_type_filling) ); 
   ...
   switch(m_type_filling)
     {
      ...
      case ORDER_FILLING_RETURN:
         ...
         m_request.type_filling=m_type_filling;
      if(TRADE_DEBUG)   Print("EXCHANGE Filling Type (Selected) for the Symbol " + symbol + " ORDER_FILLING_RETURN |value |  " + IntegerToString(m_type_filling) );
         return(true);
     }
